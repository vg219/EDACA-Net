function res = analysis_ref_unbatched_images(dir_path, ratio, sensor, flag_cut_bounds, printout)
    ...
    if sensor == "wv3" || sensor == "wv2" || sensor == "qb"
        ...
        if sensor == "wv3"
            C = 8;
            gt_path = "/Data3/cao/ZiHanCao/datasets/pansharpening/wv3/reduced_examples/test_wv3_multiExm1.h5";
        elseif sensor == "wv2"
            C = 8;
    ...
    elseif sensor == "gf2" || sensor == "gf"
        ...
        gt_key = 'gt';
        C = 4;
        gt_path = "/Data3/cao/ZiHanCao/datasets/pansharpening/gf/reduced_examples/test_gf2_multiExm1.h5";
