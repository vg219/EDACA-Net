...
import os
os.chdir('/Data3/cao/ZiHanCao/exps/panformer/task_datasets/DIF')

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--img-path', type=str, default='/Data3/cao/ZiHanCao/datasets/VIF-MSRS/test/vi')
    parser.add_argument('--outdir', type=str, default='/Data3/cao/ZiHanCao/exps/panformer/task_datasets/DIF/vis_depth')
