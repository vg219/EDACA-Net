...
def clip_norm_(max_norm, network, fp_scaler=None, optim=None, accelerator: "Accelerator | None"=None):
...
def clip_value_(max_value, network, fp_scaler=None, optim=None, accelerator: "Accelerator | None"=None):
    if fp_scaler is not None:
        fp_scaler.unscale_(optim)
    if accelerator is not None:
        if accelerator.sync_gradients:
