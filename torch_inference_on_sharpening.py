...
name = "RWKVFusion_v10_multi_modal"
subarch = ".RWKVFusion"
load_from_logs = True
dl_bs = 1
crop_bs = 6
...
# p = '/Data2/ZiHanCao/exps/panformer/log_file/panRWKV_v8_cond_norm/wv3/2024-08-08-15-14-57_panRWKV_iqet3z7x_k=2 with q shift conditional scale shift gated for attn and ffn with parallel MIFM/weights/ema_model.pth'
p = '/Data3/cao/ZiHanCao/exps/panformer/log_file/RWKVFusion_v10_multi_modal.RWKVFusion/wv3/2024-09-09-16-41-28_panRWKV_0unajc7q_RWKVFusion_v10 multi-modal input with llm feature/weights/ema_model.pth'
...
# p = 'weight/gf2_6xvqwna4_ema_model.pth'
# p = '/Data2/ZiHanCao/exps/panformer/log_file/panRWKV_v8_cond_norm/gf2/2024-08-09-03-09-26_panRWKV_u4o64esy_k=2 with q shift conditional scale shift gated for attn and ffn with parallel MIFM/weights/ema_model.pth'
# =================================================
...
model = module_load(p, model, device, strict=True, spec_key='shadow_params')  # ema_model.shadow_params
...
if save_mat:  # torch.tensor(d['sr'][:, [4,2,0]]),  torch.tensor(d['gt'][:, [4,2,0]])
    ...
    if save_format == "mat":
        ...
        save_file.close()
    logger.info(f"save results in {path}")
# -----------------------------------------------------
