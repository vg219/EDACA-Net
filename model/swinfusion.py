...
class SwinFusion(BaseModel):
    ...
    def fusion_train_step(
        ...
        **_kwargs,
        ...
        fused_outp = self._forward_implem(vi, ir)
...
if __name__ == '__main__':
    ...
    def measure_throughput(model: "torch.nn.Module", 
                        input_size: "list[tuple[int, ...]] | tuple[int, ...]",
                        batch_size: int,
                        num_warmup: int=10, 
    ...
    upscale = 1
    window_size = 8
    height = (64 // upscale // window_size) * window_size
    width = (64 // upscale // window_size) * window_size
    model = SwinFusion(upscale=1, img_size=(height, width),
                   window_size=window_size, img_range=1., depths=[6, 6, 6, 6],
                   embed_dim=60, num_heads=[6, 6, 6, 6], mlp_ratio=2, upsampler='null',
    ...
    # measure_throughput(model, [(1, height, width), (1, height, width)], 16, num_warmup=10, num_iterations=50)
