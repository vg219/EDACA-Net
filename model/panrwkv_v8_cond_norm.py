...
logger = easy_logger(func_name='RWKVFusion_v8')
...
@register_model("panRWKV_v8_cond_norm")
...
if __name__ == "__main__":
    ...
    # mask = torch.randint(0, 9, (bs, 1, img_size * scale, img_size * scale)).to(img)
    # mask = None
    
    # output = net._forward_implem(img, cond)
    # print(output.shape)
    ...
    # ## memory usage
    # print("Memory usage:")
    # print(memory_summary(device=device, abbreviated=True))
